...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002264810255'))  # Log channel id (make sure bot is admin)
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002244888139 -1002824643553')  # Channel/Group ID for force sub (make sure bot is admin)
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002244888139 -1002824643553').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002244888139 -1002824643553').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://LUCK:LUCK@cluster0.2xmja.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://FILE:FILE@cluster0.2uh0h.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
DEENDAYAL_VERIFIED_LOG = int(environ.get('DEENDAYAL_VERIFIED_LOG', '-1002264810255'))  # Log channel id (make sure bot is admin)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/raxie_catbot/148')  # How to open tutorial link for verification
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/raxie_catbot')
